...
4. Add the language inside this file [languages.json](https://github.com/Th3C0D3R/FoBCS/blob/master/ForgeOfBots/languages.json) and use the next number for the *index*-field. For the *language* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNjI2ODg2NTUsNzY5NjAyNjQ4LC03Mj
g0MDA1Nl19
-->