...
namespace ForgeOfBots.GameClasses.GEX.StartFight
{
   public class StartFightGEX
   {
      public StartFightResponse[] startfightresponse { get; set; }
   }
   ...
   public class Details
   {
      ...
      public int waveModifier { get; set; }
