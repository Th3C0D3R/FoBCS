...
namespace ForgeOfBots.GameClasses
{
    public static class ListClass
    {
        ...
        public static Dictionary<string, string> ServerList { get; set; } = new Dictionary<string, string>()
      {
        ...
        public static Dictionary<int, bool> doneMotivate { get; set; } = new Dictionary<int, bool>();
        public static Dictionary<int, bool> doneTavern { get; set; } = new Dictionary<int, bool>();
    }
